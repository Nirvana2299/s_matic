...
export default function ImpPoints() {
    return <div className="md:text-center text-white md:text-start flex md:flex-row md:px-22 lg:px-32 xl:px-56 md:py-10 py-4 bg-[#fff] flex-col gap-6 md:gap-4">
        <div className="text-center relative flex flex-col w-full md:w-80 p-8 gap-4 bg-white text-black drop-shadow rounded-lg">
            ...
            {/* <Reveal slideFromSide={true} className='flex justify-center' style={{}}> */}
        ...
        <ul className="w-full md:w-4/5 grid md:grid-cols-2 text-white py-4 md:py-0 bg-gray-200 rounded-lg">
            {
                aboutData.map((a) => {
                    return <Reveal >
                    <li key={a.id} className='py-4 md:py-4 px-4'>
